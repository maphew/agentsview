...
func writeOneSessionBatchTx(
	...
	if _, err := tx.Exec(`
		...
		write.Signals.QualitySignals.Version,
		write.Signals.QualitySignals.ShortPromptCount,
		write.Signals.QualitySignals.UnstructuredStart,
		write.Signals.QualitySignals.MissingSuccessCriteriaCount,
		write.Signals.QualitySignals.MissingVerificationCount,
		write.Signals.QualitySignals.DuplicatePromptCount,
		write.Signals.QualitySignals.NoCodeContextCount,
		write.Signals.QualitySignals.RunawayToolLoopCount,
		write.Session.ID,
	); err != nil {
		return 0, fmt.Errorf(
