...
# paths, usage aggregation, secret scanning). This target is the
...
# Run it before and after touching a sync or DB hot path.
BENCH_GATE_PACKAGES ?= ./internal/sync ./internal/artifact ./internal/db ./internal/secrets
